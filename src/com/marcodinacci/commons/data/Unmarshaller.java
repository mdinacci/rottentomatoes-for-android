...
public interface Unmarshaller<T> {
	 ...
	 * 
	 * @param rootClass The class of the unmarshalled object.
	 * @param data A String containing the raw data to unmarshal
	 * @return a new object of type T
	 * @throws Exception
	 */
	public T unmarshal(Class<T> rootClass, String data) throws UnmarshallerException;
}
